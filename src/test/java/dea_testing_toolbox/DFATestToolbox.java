...
public class DFATestToolbox {
    public static Map<DFAState, Map<String, DFAState>> mockStateTransitionTable() {
    ...
    public static void printTables(Map<DFAState, Map<String, DFAState>> stateTransitionTable, DFACreator creator) {
        GsonBuilder builder = new GsonBuilder();
        Gson gson = builder.enableComplexMapKeySerialization().create();
        Type type = new TypeToken<Map<DFAState, Map<String, DFAState>>>(){}.getType();
